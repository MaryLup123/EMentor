...
namespace eduMentor.Migrations
{
    ...
    [Migration("20251103023614_AddProgresoContenido")]
    partial class AddProgresoContenido
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("eduMentor.Models.Contenido", b =>
                {
                    ...
                    b.Property<string>("JsonContenido")
                        .IsRequired()
                        .HasColumnType("jsonb");
            ...
            modelBuilder.Entity("eduMentor.Models.ProgresoContenido", b =>
                {
                    b.Property<int>("IdProgresoContenido")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("IdProgresoContenido"));
            ...
            modelBuilder.Entity("eduMentor.Models.ProgresoContenido", b =>
                {
                    b.HasOne("eduMentor.Models.Contenido", "Contenido")
                        .WithMany("Progresos")
                    ...
                    b.HasOne("eduMentor.Models.Usuario", "Estudiante")
                        .WithMany("ProgresosContenidos")
                        .HasForeignKey("IdEstudiante")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("eduMentor.Models.Modulo", null)
                        .WithMany("ProgresosContenidos")
            ...
            modelBuilder.Entity("eduMentor.Models.Modulo", b =>
                {
                    ...
                    b.Navigation("ProgresosContenidos");
                });
